  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0b1118] px-4">
      <div className="text-center max-w-sm">
        <div className="w-20 h-20 rounded-2xl bg-[#10161c] border border-[#20252c] flex items-center justify-center mx-auto mb-6">
        ...
        <button
          ...
          className="px-6 py-2.5 rounded-xl text-sm font-semibold bg-[#00E2B5] text-[#0b1118] hover:opacity-90 transition-opacity cursor-pointer"
        >
          ลองใหม่
        </button>
      </div>
