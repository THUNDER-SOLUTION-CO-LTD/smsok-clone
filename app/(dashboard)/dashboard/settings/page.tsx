  ...
  return (
    ...
    <div className="p-6 md:p-8 max-w-4xl animate-fade-in-up">
      ...
      <div className="space-y-6 stagger-children">
        {/* Profile Card */}
        <div className="bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-[20px] p-6 md:p-8 relative overflow-hidden">
        ...
        {/* Danger Zone */}
        <div className="bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-[20px] p-6 md:p-8 border-red-500/10">
